...
const ListingCard = ({ listing }) => {
    ...
    // Prevent crash if listing is undefined
        ...
        <div className='relative bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition'>
            ...
            <div className='p-5 pt-8'>
                ...
                <div className='flex flex-wrap justify-between max-w-lg items-center  gap-3 my-5'>
                    <div className='flex items-wrap justify-between max-w-lg items-center gap-3 my-5'>
              ...
              <div className='flex items-center justify-between'>
                  ...
                  <button onClick={()=>{navigate(`/listings/${listing.id}`); scrollTo(0,0)}} className='px-7 py-3 bg-indigo-600 text-white text-sm rounded-lg hover:bg-indigo-700 transition'>
                    More Details
                  </button>
              </div>
            </div>
